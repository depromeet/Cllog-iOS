...
/// Since AccountDomain is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AccountDomain_AccountDomain"
    ...
    fatalError("unable to find bundle named AccountDomain_AccountDomain")
}()
}
...
@objc
public class AccountDomainResources: NSObject {
