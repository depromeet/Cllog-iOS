...
/// Since Account is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Account_Account"
    ...
    fatalError("unable to find bundle named Account_Account")
}()
}
...
@objc
public class AccountResources: NSObject {
