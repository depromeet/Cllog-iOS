...
/// Since AccountPresentation is a staticFramework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "AccountPresentation_AccountPresentation"
    ...
    fatalError("unable to find bundle named AccountPresentation_AccountPresentation")
}()
}
...
@objc
public class AccountPresentationResources: NSObject {
